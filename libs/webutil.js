...
export default class WebUtil {
  ...
  /**
   * Get the text of the element associated with the current locator,
   * filtered by the specified tag name.
   * @param {Locator} locator - The Playwright locator for the element to retrieve text from.
   * @param {string} tagName - The name of the tag to filter by (e.g. "p", "span", etc.).
   * @returns {Promise<string>} A Promise that resolves to the text of the element, filtered
   * by the specified tag name.
   */
  async getTextByTag(locator, tagName) {
    this.locator = locator;
   ...
   * @param {Locator} The Playwright locator for the element to retrieve the attribute from.
   * @param {string} The name of the attribute to retrieve (e.g. "class", "data-attr", etc.).
   * @returns {Promise<string>} A Promise that resolves to the value of the specified attribute
   * on the element.
   */
 ...
 */
   ...
   * This wrapper method calls a scroll script in page.evaluate, i.e. page.evaluate(scroll,
   *  { dir: 'direction', spd: 'speed' });
